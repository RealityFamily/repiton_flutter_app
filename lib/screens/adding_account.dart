...
class AddingAccount extends StatefulWidget {
  final Teacher teacher = Teacher.empty();
  final Student student = Student.empty();

  AddingAccount({Key? key}) : super(key: key);

  @override
  State<AddingAccount> createState() => _AddingAccountState();
}

class _AddingAccountState extends State<AddingAccount> {
