...
class _AuthRestApi implements AuthRestApi {
  ...
  Future<UserAuthResponse> auth({required body}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<UserAuthResponse>(
        Options(method: 'POST', headers: _headers, extra: _extra)
            .compose(_dio.options, 'user/signin', queryParameters: queryParameters, data: _data)
  ...
  Future<UserAuthResponse> getUserInfo() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<UserAuthResponse>(
        Options(method: 'GET', headers: _headers, extra: _extra)
            .compose(_dio.options, 'user/validateToken', queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = UserAuthResponse.fromJson(_result.data!);
    return value;
  }
